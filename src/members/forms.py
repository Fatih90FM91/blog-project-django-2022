...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields =('bio' ,'website_url' ,'facebook_url' , 'instagram_url' ,'linkedin_url' ,'printerest_url' ,'portfolio_url' ,'indeed_url' ,'youtube_url' ,'twitter_url')
        ...
        widget = {
            ...
            'indeed_url' : forms.TextInput(attrs={'class' : 'form-control'}),
